 ...
 *
 * После Фазы 8 уровни GM больше не живут здесь: отметка с количеством
 * операции хранится в gm_level_actions. Здесь остался только таймер CLMM,
 * у которого объёма операции по природе нет. Риск ликвидации не отмечается:
 * HF — состояние, а не
...
/** Виды сигналов, у которых отметка осмысленна после Фазы 8. */
const ACKABLE_PREFIXES = ["clmm-ready:"] as const;
