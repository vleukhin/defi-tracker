    ...
    <form onSubmit={submit} className="flex flex-col gap-3">
      ...
      {withEntryPrice && (
        <AmountField
          ...
          hint="Цена текущей точки отсчёта. Правка исправляет последнюю запись журнала и не начинает новый цикл: отметки уровней сохранятся. Для нового цикла используйте «Перенести точку» рядом со шкалой."
        />
      )}
