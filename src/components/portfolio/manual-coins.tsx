  ...
  return (
    <DcCard as="section">
      <SectionHead
        ...
        hint="Залог в лендинге читается автоматически — вносить его сюда не надо. Здесь только монеты вне лендинга: биржа, холодный кошелёк, проинвестированные стейблы."
        action={
          entries === null ? null : (
