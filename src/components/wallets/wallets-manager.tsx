      ...
      <DcCard>
        {error && !wallets ? (
          ...
          <>
                ...
                <tr>
                  ...
                  <Th>
                    <span className="inline-flex items-center gap-1.5">
                      Что читаем
                      <HelpTip>
                        Что нашлось у адреса: залог Aave, позиции Fluid, GMX
                        и Uniswap, а также свободные монеты — те, что просто
                        лежат на кошельке. Пометить их своими или заёмными
                        можно на «Портфеле» в режиме «Зоны».
                      </HelpTip>
                    </span>
                  </Th>
            ...
            >
              Свободные монеты на этих адресах читаются автоматически. То,
              чего приложение не видит — биржа и кошельки вне списка, —
